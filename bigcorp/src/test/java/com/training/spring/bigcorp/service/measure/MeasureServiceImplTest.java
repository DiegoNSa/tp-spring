...
private SimulatedCaptor simulatedCaptor;
    ...
    public void init() {
        ...
        simulatedCaptor = new SimulatedCaptor("test", site, (long)500_000, (long)1_000_000);
        simulatedCaptor.setId("id1");
        fixedCaptor = new FixedCaptor("test", site, (long)500_000);
    ...
    public void readMeasures() {
        ...
        Mockito.when(MeasureServiceImplTestConfig.measureDao.findMeasureByIntervalAndCaptor(eq(start), eq(end), anyString()))
