...
public class SimulatedMeasureService implements MeasureService {
    ...
    @Autowired
    public SimulatedMeasureService(BigCorpApplicationProperties bigCorpApplicationProperties){
    ...
    public List<Measure> readMeasures(Captor captor, Instant start, Instant end,
                                      MeasureStep step) {
        defaultValue = bigCorpApplicationProperties.getMeasure().getDefaultSimulated();
